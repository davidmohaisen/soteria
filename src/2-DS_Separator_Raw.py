...
def mnist_tutorial_cw(train_start=0, train_end=60000, test_start=0,
    ...
    for i in range(len(ShuffleArray)):
        for j in range(len(ShuffleArray[i])):
            if j < 0.8*sizes[i]:
                for k in range(10):
                    x_train.append(x_all[i][ShuffleArray[i][j]+k])
                    y_train.append(labels[i])
            else:
                for k in range(10):
                    x_test.append(x_all[i][ShuffleArray[i][j]+k])
                    y_test.append(labels[i])

    x_trainFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/x_train_Dense_Raw.pkl', 'wb')
    y_trainFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/y_train_Dense_Raw.pkl', 'wb')
    x_testFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/x_test_Dense_Raw.pkl', 'wb')
    y_testFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/y_test_Dense_Raw.pkl', 'wb')
    # x_trainFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/x_train_Levels_Raw.pkl', 'wb')
    # y_trainFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/y_train_Levels_Raw.pkl', 'wb')
    # x_testFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/x_test_Levels_Raw.pkl', 'wb')
    # y_testFile = open('/home/ahmed/Documents/Projects/IoT_Defence/DSSeparatedRaw/y_test_Levels_Raw.pkl', 'wb')
    pickle.dump(x_train, x_trainFile)
    pickle.dump(x_test, x_testFile)
    pickle.dump(y_train, y_trainFile)
    pickle.dump(y_test, y_testFile)
